...
public class FeedParser {
    ...
    public static List<Article> parseXML(String xmlData) {
        ...
        try {
            ...
            NodeList nList = doc.getElementsByTagName("item"); // Obtengo los "elementos" y me fijo cuántos hay. Cada
                                                               // elemento es un artículo.
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == org.w3c.dom.Element.ELEMENT_NODE) {
                    ...
                    articles.add(new Article(title, description, pubDate, link)); // Creo un nuevo artículo y lo agrego
                                                                                  // a la lista.
                }
            }
        } catch (Exception e) {
